...
namespace Network01_Client
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Connection Enstablished...Enter Username and Password:");

            string[] sUsernamePass = Console.ReadLine().Split(new char[] { ' ' });

            if (hClient.Login(sUsernamePass[0], sUsernamePass[1]))
            {
                Console.Write("Channel:");
                hClient.Join(Console.ReadLine());
